...
- Neste projeto, recebi uma tabela não normalizada que simula o banco de dados simplificado do Spotify, a qual precisou ser normalizada e populada para que qualquer usuário possa executar queries com o intuito de encontrar as informações solicitadas.

- Normalização de tabela na terceira forma normal e acesso de informações desta tabela através de `queries` utilizando `SQL`.
